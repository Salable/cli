...
export const choosePlanFeatureValue = async ({
  ...
  // 1. For each plan on the product, prompt the user to select the values for the feature being created
  ...
  // 2. Transform the output into the expected data type for the API request
